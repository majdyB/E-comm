          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                ...
                <a class="nav-link" href="services.jsp?admin=<%=session.getAttribute("type") %>">Services</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item active"> 
            	  <a class="nav-link" href="login.jsp"><%=session.getAttribute("name")%></a>
               </li>
        ...
        <nav class="mobile_header navbar navbar-expand-lg navbar-light bg-light">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent2">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="services.jsp?admin=t">Services</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="contact.html">Contact</a>
              </li>
            ...
            <div class="col-md-6">
              <h1 class="contact_text">Contact Us</h1>
                <form action="SendMsg.jsp">
                  ...
                  <div class="form-group">
                    <input type="text" class="email-bt" placeholder="Subject" name="subj">
                  </div>
                    <div class="form-group">
                      <textarea class="massage-bt" placeholder="Massage" rows="5" id="comment" name="text"></textarea>
                    </div>
                     <input style="background-color: #343a40;  color: white;  padding: 12px 24px;  border: none;  cursor: pointer; border-radius: 100px; width: 300px; height: 50px" type="submit" value="Send" >
                      
              
              <div>
                <INPUT TYPE="radio" name="command" value="0"/>AR
                      <INPUT TYPE="radio" NAME="command" VALUE="1" style="back"/>EN
                   </div>  
