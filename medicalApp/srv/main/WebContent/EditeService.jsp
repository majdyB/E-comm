...
String notice=request.getParameter("notice");
      try {
			...
			PreparedStatement pst=con.prepareStatement("Update services set title=? ,SD=?,LD=?,img=?,price=?,notice=? Where id=?");
			...
			if(rs >0){
				...
				%>	<h1 class='contact_text' style="color:black; padding-top: 200px;">Edite Service Successful</h1><%  
						con.close();
		
			}
			else{
				%><h1 class='contact_text' style="color:black; padding-top: 200px;">Edite Service Faild</h1><%
				con.close();
