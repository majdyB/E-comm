...
String id=request.getParameter("id");
      ...
      try {
			...
			PreparedStatement pst=con.prepareStatement("DELETE FROM services WHERE id= ?");
			pst.setString(1, id);
			int rs=pst.executeUpdate();
			if(rs >0){
				
				%><h1 class='contact_text' style="color:black; padding-top: 200px;">Delete Service Successful</h1><% 
						con.close();
			}
			else{
				%><h1 class='contact_text' style="color:black; padding-top: 200px;">Delete Service Faild</h1><%
						con.close();
