...
<html lang="en">
    ...
    String t=request.getParameter("title");
      ...
      try {
			...
			PreparedStatement pst=con.prepareStatement("select * from services where title = ?");
			pst.setString(1,t);
			ResultSet rs=pst.executeQuery();
			while(rs.next()){%>
			<div class="row">
            <div class="col-md-6">
              <div class="about_taital" align="center" style="padding: 35px;">
                <h4 class="highest_text"><%=rs.getString(2) %></h4>
                <h1 class="about_text"><%=rs.getString(3) %></h1>
                <p class="lorem_text"><%=rs.getString(4) %></p>
                <h1 class="about_text"><%=rs.getString(6) %> $</h1>
                <h1 class="about_text"><%=rs.getString(7) %></h1>
                
              </div>
            </div>
            <div class="col-md-6">
              <img src="assets/<%=rs.getString(5) %>" style="width:500px;height:500px;">
            </div>
          </div>
			   <%
