...
String notice=request.getParameter("notice");
      try {
			...
			PreparedStatement pst=con.prepareStatement("insert into services(title,SD,LD,img,price,notice)values(?,?,?,?,?,?)");
			...
			if(rs >0){
				...
				%><h1 class='contact_text' style="color:black; padding-top: 200px;">Add Service Successful</h1><% 
				con.close();
		
			}
			else{
				%><h1 class='contact_text' style="color:black; padding-top: 200px;">Add Service Faild</h1><%
						con.close();
			}
      }catch(Exception e){
    	  out.print(e);
